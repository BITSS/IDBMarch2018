...
2. Rigor and transparency can be demonstrated in other ways (e.g. good robustness checks).  
3. More difficult with a PAP to make serendipitous discoveries the main story. That’s as it should be.   
